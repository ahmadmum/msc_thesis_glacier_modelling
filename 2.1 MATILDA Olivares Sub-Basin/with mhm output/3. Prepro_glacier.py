...
df = pd.read_csv(home + "/Desktop/Thesis/Modelling/Matlida/5. matilda-maipo-final/1. Rio Olivares_GIS/8/Export_Output.txt")
...
Glacier_profile.to_csv(r'C:\Users\mumta\Desktop\Thesis\Modelling\Matlida\4. matilda-maipo\3. Example Juncal gl\glacier_profile.csv',index=False,  header=True)
