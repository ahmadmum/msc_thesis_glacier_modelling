...
mydir = "C:/Users/mumta/Desktop/Thesis/Modelling/Matlida/6. Thesis/1. Olivares/Camel/2008_2018/"
...
output_matilda = matilda_simulation(df, obs=obs, output=mydir,
                                    set_up_start='2008-01-01', set_up_end='2008-12-31',  # Min. 1y recommended
                                    sim_start='2009-01-01', sim_end='2018-12-31',
                                    freq="D",  # Temporal resolution ("D", "M" or "Y")
                                    lat = -33.49, area_cat = Catchment_area , area_glac = 79.99, 
                                    ele_dat = 3126.5, ele_glac = 4673.5, ele_cat = 3748,
